...
function setup() 
{
  ...
  star_display.addAnimation('emptyStar',empty_star)
  star_display.addAnimation('oneStar',one_star)
  star_display.addAnimation('twoStars',two_star)
  star_display.changeAnimation('emptyStar')
  ...
  star=createSprite(300,50,100,100)
  star.scale=0.02
  star.addImage(star_Img)

  star2=createSprite(50,370,100,100)
  star2.scale=0.02
...
function draw() 
{
  ...
  if(collide(fruit,star,80)==true){
    star.visible=false
    star_display.changeAnimation('oneStar')
  }
  if(collide(fruit,star2,80)==true){
    star2.visible=false
